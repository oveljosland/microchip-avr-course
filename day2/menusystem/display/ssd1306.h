...
#define __SSD1306_H__
  ...
  #define SSD1306_ERROR           (uint8_t)  -1
   ...
   * @brief   SSD1306 Init
   *
   * @param   uint8_t address of screen
   *
   * @return  uint8_t
   */
   ...
   *
   * @param   uint8_t command to be sent
   *
   * @return  uint8_t
   */
  ...
  /**
   * @brief   SSD1306 Set position for cursor when writing strings
   *
   * @param   uint8_t x, column -> 0 ... 127 
   * @param   uint8_t y, page -> 0 ... 7 or 3 
   *
   * @return  void
   */
   ...
   *
   * @param   char * C-string to be drawn.
   *
   * @return  void
   */
